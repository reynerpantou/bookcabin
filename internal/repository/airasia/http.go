...
type HTTP interface {
	Search(ctx context.Context, params *requestparamsmodel.RequestParams) (airasiamodel.SearchResponse, error)
}
...
func (h *httpImpl) Search(ctx context.Context, params *requestparamsmodel.RequestParams) (airasiamodel.SearchResponse, error) {
	if params == nil {
		return airasiamodel.SearchResponse{}, fmt.Errorf("params is nil")
	}
